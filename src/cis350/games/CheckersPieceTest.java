...
public class CheckersPieceTest extends TestCase {
	...
	public void testEnemyCapture() {
		...
		checkersPawn whitePawn = new checkersPawn(1, 1, Color.white, board);
		checkersPawn blackPawn = new checkersPawn(2, 2, Color.black, board);
		assertTrue(whitePawn.canMove(3, 3));
		whitePawn.executeCaptureOrMove(3, 3);
		assertTrue(whitePawn.xLocation == 3 && whitePawn.yLocation == 3);
	...
	public void testInvalidPositiveBoundsMove() {
		checkersStandardBoard board = new checkersStandardBoard(8,8);
		checkersPawn whitePawn = new checkersPawn(7, 7, Color.white, board);
	...
	public void testInvalidNegativeBoundsMove() {
		checkersStandardBoard board = new checkersStandardBoard(8,8);
		checkersPawn whitePawn = new checkersPawn(0, 1, Color.white, board);
