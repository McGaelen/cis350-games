...
public class CheckersPawnTest extends TestCase {
	...
	public void testValidWhitePawnMove(){
		...
		checkersPawn newPawn = new checkersPawn(1, 1, Color.white, board);
	...
	public void testValidBlackPawnMove(){
		checkersStandardBoard board = new checkersStandardBoard(8,8);
		checkersPawn newPawn = new checkersPawn(4, 4, Color.black, board);
	...
	public void testInvalidPawnMove(){
		checkersStandardBoard board = new checkersStandardBoard(8,8);
		checkersPawn newPawn = new checkersPawn(1, 4, Color.black, board);
	...
	public void testValidEnemyPieceMove(){
		checkersStandardBoard board = new checkersStandardBoard(8,8);
		checkersPawn newPawn = new checkersPawn(2, 2, Color.white, board);
		checkersPawn enemyPawn = new checkersPawn(3, 3, Color.black, board);
	...
	public void testInvalidEnemyPieceMove(){
		...
		checkersPawn newPawn = new checkersPawn(2, 2, Color.white, board);
		checkersPawn enemyPawn = new checkersPawn(3, 3, Color.black, board);
		checkersPawn enemyPawn2 = new checkersPawn(4, 4, Color.black, board);
