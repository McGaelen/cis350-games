...
public class CheckersGame extends Observable {
    ...
    public void gameInit() {
        ...
        gameTurn = CheckersBoard.Color.white;
        gameOver = false;
        squareSize = 80;
    ...
    static void getGamePlayers() {
        ...
        whitePlayer = new CheckersPlayer(
                whiteName, CheckersBoard.Color.white
        );
        blackPlayer = new CheckersPlayer(
                blackName, CheckersBoard.Color.black
        );
    }
    ...
    private void restartGame() {
        String player;
        if (gameTurn.equals(CheckersBoard.Color.white)) {
    ...
    private void forfeitGame() {
        ...
        if (gameTurn == CheckersBoard.Color.white) {
