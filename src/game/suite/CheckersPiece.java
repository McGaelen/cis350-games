...
public abstract class CheckersPiece {
     ...
     */
    private CheckersBoard.Color color;
    /**
     ...
     * @return color
     */
    public CheckersBoard.Color getColor() {
        return this.color;
    }
     ...
     */
    public void setColor(final CheckersBoard.Color col) {
        this.color = col;
    }
    ...
    public CheckersPiece(
            final int initX,
            final int initY,
            final CheckersBoard.Color colorParam,
    ...
    public boolean isKingInCheck(final CheckersKing kingToCheck) {
        ...
        CheckersBoard.Color colorToCheck = kingToCheck.getColor();
    ...
    private boolean isKingInDanger(final int newPieceX, final int newPieceY) {
        ...
        if (squareToCheck.getIsOccupied()) {
            ...
            if (isEnemyPieceAtDestination(newPieceX, newPieceY)) {
                ...
                if (this.color.equals(CheckersBoard.Color.white)) {
    ...
    private boolean isEnemyPiece(
            final CheckersBoard.Color colorToCheck,
    ...
    public void drawPiece(
            ...
            final int x,
            final int y) {
        if (this.color.equals(CheckersBoard.Color.black)) {
